...
class Caixaparan extends StatelessWidget {
  const Caixaparan({
    Key? key,
    ...
    required this.circleAvatarColor, // Adiciona a propriedade circleAvatarColor
  }) : super(key: key);
  ...
  final Color circleAvatarColor; // Propriedade para a cor do CircleAvatar
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Center(
        child: Row(
          children: [
            const SizedBox(width: 10), // Adiciona um espaçamento entre o CircleAvatar e a Column
            Expanded(
              child: Column(
            ...
            CircleAvatar(
              backgroundColor: circleAvatarColor, // Usa a cor definida na propriedade
              radius: 13,
            ),
          ],
        ),
