...
import 'package:telas/widgets/caixaparanlabel.dart';
import 'package:telas/widgets/widgetlabel.dart';

class Caixaparanresul extends StatelessWidget {
  const Caixaparanresul({
    Key? key,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Widgetlabeltransparenteparancaix(param: paramText2, lablText: lablText2),
                ],
              ),
            ),
          ],
